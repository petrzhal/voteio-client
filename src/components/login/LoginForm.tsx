...
const LoginForm: FC = () => {
    ...
    const handleRegister = async () => {
        ...
        if (await store.register(login, password)) {
            store.setAuth(true);
            navigate('/home');
        } else {
                    ...
                    <form className="form">
                        ...
                        <div className="field">
                            ...
                            <input onChange={(e) => setLogin(e.target.value)} value={login} type="text"
                                   className="input-field" placeholder="Username" autoComplete="on"/>
                        </div>
                        <div className="field">
                            <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16"
                                 xmlns="http://www.w3.org/2000/svg" className="input-icon">
                        ...
                        <div className="btn">
                            ...
                            <button onClick={handleRegister} className="button2" type={"button"}>Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>
